...
module.exports = class ActorRoomUpgrade extends ActorWithMemory
{
	...
	initiateActor(parentId, roomName)
	{
		...
		parent.requestResource(upgradeContainerPos, RESOURCE_ENERGY, PRIORITY_NAMES.RESOURCE.UPGRADE, TARGET_RESOURCE_RESERVE);
	...
	createUpgrader(spawnId)
	{
        ...
        this.core.createActor(ACTOR_NAMES.PROCEDUAL_CREEP,
            ...
            , [CREEP_INSTRUCTION.PICKUP_AT_POS, 		this.memoryObject.energyPos,	RESOURCE_ENERGY,	1000] //1
